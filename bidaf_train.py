...
#def main():
    ...
    max_question_len,max_evidence_len = get_max_length(training_file)
    embeddings,word2idx = load_embedding(embedding_file)
    questions,evidences,y1,y2 = load_data(training_file,word2idx,max_question_len,max_evidence_len)
